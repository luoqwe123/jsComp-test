...
// const fristDay = getMonthFristWeekDay(year,month);
// const lastNum = getLastMonthRestDay(year,month,fristDay);
// console.log(lastNum);

// const currentNum = getCurrentMonthDays(year,month);
// console.log(currentNum);

// console.log(getNextMonthRestDay(currentNum.length,lastNum.length));
